...
function UsersList(props) {
    ...
    const handleDelete = userId => {
      deleteUser(userId);
      removeUserFromApartments(userId);
    };
    ...
    <TableContainer component={Paper}>
      ...
      <Table aria-label="simple table">
          <TableHead>
            ...
            <TableCell style={{color: '#fff', fontSize: 12}}><b>id</b></TableCell>
            <TableCell style={{color: '#fff', fontSize: 12}}><b>Firstname</b></TableCell>
            <TableCell style={{color: '#fff', fontSize: 12}}><b>Lastname</b></TableCell>
            <TableCell style={{color: '#fff', fontSize: 12}}><b>Delete</b></TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {props.data.map((user) => (
